...
public class MongoOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    private final MongoOAuth2AuthorizationRepository mongoOAuth2AuthorizationRepository;

    public MongoOAuth2AuthorizationService(RegisteredClientRepository registeredClientRepository, MongoOAuth2AuthorizationRepository mongoOAuth2AuthorizationRepository) {
        this.registeredClientRepository = registeredClientRepository;
        this.mongoOAuth2AuthorizationRepository = mongoOAuth2AuthorizationRepository;
        Assert.notNull(mongoOAuth2AuthorizationRepository, "mongoOAuth2AuthorizationRepository cannot be null");
    ...
    public void remove(OAuth2Authorization authorization) {
        mongoOAuth2AuthorizationRepository.deleteById(authorization.getId());

    }

    @Override
    public OAuth2Authorization findById(String id) {
        return mongoOAuth2AuthorizationRepository.findById(id)
                .orElse(null);
    }
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        return mongoOAuth2AuthorizationRepository.findByAccessToken(token)
                .orElse(null);
