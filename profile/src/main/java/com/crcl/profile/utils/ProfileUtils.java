...
public class ProfileUtils {
    ...
    public static ProfileDto getDefaultProfile(UserDto user) {
        ...
        HashMap<NotificationDefinition, NotificationTargets> targetsMap = new HashMap<>();
        Arrays.stream(NotificationDefinition.values()).forEach(notificationDefinition -> targetsMap.put(notificationDefinition, NotificationTargets.All_FRIENDS));
        notificationSettings.setTargetsSettings(targetsMap);
        Settings settings = new Settings().setNotificationSettings(notificationSettings);
