...
public class ProfileController {
    ...
    @GetMapping("/notifications/{username}/target")
    @SneakyThrows
    public ResponseEntity<NotificationTargets> getNotificationSettings(@PathVariable String username, @RequestParam NotificationDefinition notificationDefinition) {
        return ResponseEntity.ok(this.profileService.getNotificationSettings(username, notificationDefinition));
    }
